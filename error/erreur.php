...
switch($_GET['erreur'])
{
	...
	case '404':
	echo '<h1 class="font-large-2 my-1">404 - Page n\'existe pas ou plus!</h1>';
	echo '<p class="p-2">
	paraphonic unassessable foramination Caulopteris worral Spirophyton encrimson esparcet aggerate chondrule
	restate whistler shallopy biosystematy area bertram plotting unstarting quarterstaff.</p>';
	break;
...
<a class="btn btn-primary btn-lg mt-2" href="index.html">Accueil</a>
                                </div>
                            </div>
                        </div>
                    </div>
