...
<head>
    ...
    <title>Communications Générale - Liste des lecteurs - Infopro-Digital</title>
            ...
            <div class="content-header row">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Communications générales</a></li>
                                    <li class="breadcrumb-item"><a href="#">Communication (X)</a></li>
                ...
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                    <div class="form-group breadcrumb-right">
                        <a class="btn-icon btn btn-primary btn-round btn-sm waves-effect waves-float waves-light" href="modif_comm.php">Revenir à la communication</a>
                    </div>
                </div>
            </div>
