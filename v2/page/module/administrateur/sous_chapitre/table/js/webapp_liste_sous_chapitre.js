$(function () {
  ...
  if (dt_basic_table.length) {
    var dt_basic = dt_basic_table.DataTable({
      ...
      language: {
        ...
        loadingRecords: "Chargement des sous chapitres en cours ..."
      }
    });
    $('div.head-label').html('<h6 class="mb-0">Liste des sous chapitres</h6>');
      ...
      if (result.value) {
              ...
              var onSuccess = function (data) {
                ...
                Swal.fire({
                  type: "success",
                  title: 'Supprimé !',
                  text: "Sous chapitre '" + name + "' supprimé avec succès.",
              ...
              var request = $.ajax({
                url:          'table/php/data_liste_sous_chapitre.php?job=del_sous_chapitre',
                data:         'id=' + id,
                type:         'post',
                async: false,
  ...
  $(document).on('submit', '.add', function(e){
    ...
    e.preventDefault();
      ...
      var onSuccess = function (data) {
        console.log('Success');
        window.location.assign("liste_sous_chapitre.php");
  ...
  $(document).on('submit', '.edit', function(e){
      ...
      var onBeforeSend = function () {
		  ...
		  var request   = $.ajax({
        url:          'table/php/data_liste_sous_chapitre.php?job=edit_sous_chapitre',
        data:         form_data,
        type:         'post',
        async: false,
        beforeSend: onBeforeSend,
