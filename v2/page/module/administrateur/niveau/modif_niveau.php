...
if(!empty($_GET["id"])){$id_niveau = $_GET["id"];}else{$id_niveau = "";}


$PDO_query_niveau_unique = Bdd::connectBdd()->prepare("SELECT * FROM methode_niveau_user WHERE niveau_id = :id ORDER BY niveau_id ASC");
$PDO_query_niveau_unique->bindParam(":id", $id_niveau, PDO::PARAM_INT);
$PDO_query_niveau_unique->execute();
$niveau = $PDO_query_niveau_unique->fetch();
$PDO_query_niveau_unique->closeCursor();
?>
...
<head>
    ...
    <title><?php if(!empty($_GET["id"])){echo'Niveau | Modification - '.$PARAM_nom_site.'';}else{echo'Niveau | Ajout - '.$PARAM_nom_site.'';} ?></title>
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static menu-collapsed pace-done" data-open="click" data-menu="vertical-menu-modern" data-col="">
            ...
            <div class="content-header row">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb d-md-flex d-none">
                                    <li class="breadcrumb-item">
                                        <a href="liste_niveau.php">Niveau</a>
                                    </li>
                                    <li class="breadcrumb-item active">Gestion du niveau</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-header-right text-md-right col-md-4 col-4">
                    <div class="form-group breadcrumb-right float-right d-flex">
                        <a class="btn btn-success" href="liste_niveau.php">Retour à la liste</a>
                    </div>
                </div>
            </div>
            <!-- Begin : main content -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Form -->
                                    <form method="post" id="jquery-val-form" class="<?php if(empty($id_niveau)){echo 'add';}else{echo 'edit';} ?>" data-id="<?php echo $id_niveau; ?>">
                                                            
                                        <input name="user" type="hidden" value="<?php echo Membre::info($_SESSION['id'], 'nom').' '.Membre::info($_SESSION['id'], 'prenom');?>">
                                        <input name="id" type="hidden" value="<?php echo $id_niveau;?>">

                                        <div class="row">

                                            <div class="col-md-12 col-12">
                                                <div class="form-group mb-2">
                                                    <label for="basic-default-nom">Nom du niveau *:</label>
                                                    <input
                                                    type="text"
                                                    class="form-control"
                                                    ...
                                                    placeholder="..."
                                                    maxlength="255"
                                                    value="<?php if(!empty($id_niveau)){echo $niveau['niveau_name'];}?>"
                                                    required
                                                    />                                                 
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group mb-2">
                                                    <label for="blog-edit-statut">Statut du Niveau *:</label>
    ...
    <script charset="utf-8"  src="<?php echo Admin::menuniveau();?>table/js/webapp_liste_niveau.js"></script>
