...
<head>
    ...
    <link rel="stylesheet" href="module/socle/table/css/layout_socle.css">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Socle</a>
                                    </li>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="divider">
                                            <div class="divider-text">Gestion du module</div>
                                                  ...
                                                  <button type="button" class="btn btn-success action-edit float-right" id="add_socle"  tabindex="0" aria-controls="DataTables_Table_0"><i class="fa fa-plus-circle mr-1"></i>Ajouter un socle</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="divider">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped dataex-html5-selectors " id="table_socle">
                                                <thead>
                                                    <tr>
                                                        <th>Socle</th>                                                     
