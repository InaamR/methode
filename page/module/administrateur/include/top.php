                    ...
                    <li class="dropdown dropdown-user nav-item">
                        ...
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            ...
                            <span class="user-name text-bold-600">
                                <?php echo ''.Membre::info($_SESSION['id'], 'nom').' '.Membre::info($_SESSION['id'], 'prenom').'';?>
                            </span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="<?php echo URLSITE.'/administrateur/admin/deconnexion.php'; ?>"><i class="feather icon-power"></i> Se déconnecter</a>
                        </div>
                    </li>
                </ul>
