...
?>
	...
	<div class="page-content">
        ...
        <div class="container-fluid">
          <h2 class="content-heading">Service / <b>Équipes</b></h2>
          ...
          <div class="main-container">
            ...
            <div class="row">
            <div class="col-lg-6">
            <button type="button" class="btn btn-secondary icon-left mr-3" id="add_orgi">Ajouter une nouvelle Équipe <span class="btn-icon iconfont iconfont-plus-v1"></span></button>
            <a class="btn btn-secondary icon-left mr-3" href="ListeUsers">Collaborateurs</a>           
            </div>
            ...
            <table class="datatable table table-striped" id="table_orgi">
            <thead>
            <tr>
            <th>NOMINATION ÉQUIPE</th>
            <th></th>
            </tr>
            </thead>
            <tbody>
...
<div class="lightbox_container">
  ...
  <div class="lightbox_content">
    ...
    <form class="form add" id="form_orgi" data-id="" novalidate>
      <div class="input_container">
        <label for="nom">NOMINATION ÉQUIPE : <span class="required">*</span></label>
...
<script charset="utf-8" src="module/admin/table/js/webapp_orgi.js"></script>
