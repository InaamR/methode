...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static   menu-collapsed" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">SERVICE ET ENTRETIEN</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Collaborateur</a>
                                    </li>
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="row justify-content-end">
                                            <div class="col-2">
                                                <!-- basic buttons -->
                                                  <button type="button" class="btn btn-success mr-1 mb-1" id="add_user"  tabindex="0" aria-controls="DataTables_Table_0">Ajouter un collaborateur</button>
                                ...
                                <div class="card-content">
                                    <div class="card-body card-dashboard">                                        
                                        <div class="table-responsive">
                                            <table class="table table-striped dataex-html5-selectors " id="table_user">
                                                <thead>
                                                    <tr>
                                                        <th>Matricule</th>
	                                                    <th>Nom complet</th>                                                       
    ...
    <!-- END: Page JS-->
    <script charset="utf-8" src="module/service_et_entretien/table/js/webapp_liste_contact.js"></script>
