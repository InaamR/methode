...
<head>
    ...
    <link rel="stylesheet" href="module/sous_chapitre/table/css/layout_sous_chapitre.css">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Sous Chapitre</a>
                                    </li>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="divider">
                                            <div class="divider-text">Gestion du module</div>
                                                  ...
                                                  <button type="button" class="btn btn-success action-edit float-right" id="add_sous_chapitre"  tabindex="0" aria-controls="DataTables_Table_0"><i class="fa fa-plus-circle mr-1"></i>Ajouter un sous chapitre</button>
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="divider">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped dataex-html5-selectors " id="table_sous_chapitre">
                                                <thead>
                                                    <tr>
                                                        <th>Sous chapitre</th> 
                                                        <th>Chapitre</th>                                                    
                                ...
                                <div class="data-fields px-2 mt-3">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 data-field-col">
                                           		...
                                           		<label for="nom_sous_chapitre">Nom du sous chapitre*</label>
                                                <div class="field_container">
                                                <input type="text" class="form-control" id="nom_sous_chapitre" name="nom_sous_chapitre" required>
                                                </div>
                                        ...
                                        <div class="col-sm-12 data-field-col">
                                                ...
                                                <div class="field_container">
                                                    ...
                                                    <select class="select2 form-control" name="nom_chapitre"  id="nom_chapitre" required>

                                                        <?php
                                                            $query = Bdd::connectBdd()->prepare("SELECT * FROM menu_chapitre");
                                                            $query->execute();
                                                            while ($query_chapitre = $query->fetch()){
                                                            
                                                            echo '<option value="'.$query_chapitre['menu_chapitre_id'].'">'.$query_chapitre['menu_chapitre_nom'].'</option>';
                                                            }
                                                            $query->closeCursor();
                                                        ?>
